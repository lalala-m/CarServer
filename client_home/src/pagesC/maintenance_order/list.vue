<template>
  <view :style="{ paddingTop: vuex_custom_bar_height + 'px' }" class="page_diy_list page_maintenance_order_list container">
	<view class="content">
...
export default {
  ...
  data() {
    return {
	  ...
	  placeholder_order_status: "请选择订单状态",
  ...
  methods: {
    ...
    get_user_financial_user(id){
      ...
      return ret;
                                                ...
                                                // 改变分类标签
        change_order_status(val) {
          if (val === "全部" || val === "") {
            this.query.order_status = "";
          }else{
            this.query.order_status = val
          }
          this.search_();
        },
                /**
