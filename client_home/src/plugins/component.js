  ...
  install(Vue, optons) {
    ...
    Vue.mixin({
      ...
      methods: {
        ...
        /**
         * 向阿里云通义千问 API 发送 POST 请求
         * @param {Object} data 请求数据
         * @param {Function} func 回调函数，可以为空，为空则采用 await 返回值
         * @param {Object} custom 自定义配置参数，默认为空对象
         * @return {Object} 返回请求结果
         */
        async $qwenPost(data, func, custom = {}) {
          if (func) {
            http
              .request({
                ...
                method: 'POST',
                header: {
                  Authorization: 'Bearer sk-afb6a8de44c247e7924b11bf240a759e',
                  'Content-Type': 'application/json',
                },
                custom,
                data,
