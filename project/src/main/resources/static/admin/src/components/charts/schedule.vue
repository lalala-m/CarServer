...
.schedule .schedule-header .schedule-header-row {
  padding: 10px 0;
  display: flex;
  align-items: center;
...
.schedule .schedule-header .schedule-header-row .schedule-header-left {
  display: flex;
  align-items: center;
}

.schedule .schedule-header .schedule-header-row .schedule-header-left .title {
  display: flex;
  align-items: center;
  font-weight: bold;
}

.schedule .schedule-header .schedule-header-row .schedule-header-left .day-date {
  display: flex;
  align-items: center;
}

.schedule .schedule-header .schedule-header-row .schedule-header-right .btn-schedule {
...
.schedule .schedule-header .schedule-header-row .schedule-header-right .me-btn-group {
  display: flex;
  align-items: center;
...
.schedule .schedule-header .schedule-header-row .schedule-header-right .me-btn-group .me-btn {
  padding: 5px 10px;
}

.schedule .schedule-header .schedule-header-row .schedule-header-right .me-btn-group .me-btn:hover {
  cursor: pointer;
...
.schedule .schedule-header .schedule-header-row .schedule-header-right .me-btn-group .me-btn.prev {
  border-right: 1px solid var(--color_border);
}

.schedule .schedule-header .schedule-header-row .schedule-header-right .me-btn-group .me-btn.next {
...
.schedule .schedule-body .parent-table {
...
.schedule .schedule-body .parent-table tbody tr:hover {
  background-color: transparent;
}

.schedule .schedule-body .parent-table tbody tr:nth-child(2n) {
  background-color: transparent;
}

.schedule .schedule-body .parent-table th,
.schedule .schedule-body .parent-table td {
  width: 14.4%;
  border: 1px solid var(--color_border);
}
...
.schedule .schedule-body .parent-table td .content {
  position: relative;
  min-height: 90px;
}

.schedule .schedule-body .parent-table td .content .top-day {
  height: 20px;
  line-height: 20px;
  color: var(--color_base);
}

.schedule .schedule-body .parent-table td .content .trip-list {
  display: flex;
  flex-direction: column;
  font-size: 12px;
  height: 66px;
...
.schedule .schedule-body .parent-table td .content .trip-list::-webkit-scrollbar {
  width: 4px;
  height: 4px;
}

.schedule .schedule-body .parent-table td .content .trip-list .trip-item {
  flex-shrink: 0;
...
.schedule .schedule-body .parent-table td .content .trip-list .trip-item:last-child {
  margin-bottom: 0;
}

.schedule .schedule-body .parent-table td .content .trip-list .ellipsis {
  overflow: hidden;
  white-space: nowrap;
  text-overflow: ellipsis;
}

.schedule .schedule-body .parent-table td .top-day {
  text-align: left;
  font-size: 13px;
}

.schedule .schedule-body .parent-table .faded {
  opacity: 0.3;
}

.schedule .schedule-body .parent-table .highlight-bg {
  background: rgba(88, 230, 255, 0.1);
}

.schedule .schedule-body .parent-table .highlight-text {
  color: #317ef3;
}

.schedule-dialog .schedule-dialog-content {
  width: 100%;
}

.schedule-dialog .schedule-dialog-content .remind-wrapper {
  display: flex;
  flex-direction: column;
}

.schedule-dialog .schedule-dialog-content .remind-wrapper .remind-title {
  font-size: 16px;
  margin-bottom: 10px;
}

.schedule-dialog .schedule-dialog-content .remind-wrapper .remind-list {
  width: 100%;
  height: 100%;
  overflow-y: auto;
  padding: 10px;
...
.schedule-dialog .schedule-dialog-content .remind-wrapper .remind-list .remind-item {
  width: 100%;
}

.schedule-dialog .schedule-dialog-footer {
  display: flex;
  justify-content: center;
}

.schedule-dialog .schedule-dialog-footer .btn-delete {
