				...
				for(var key in form_sub){
					...
					try{
						...
						if(value && value instanceof Date){
							...
							if(owner_user_field.indexOf(key) == -1){
								delete form_sub[key];
							}
						}
							...
							if(business_user_field.indexOf(key) == -1){
								delete form_sub[key];
							}
						}
							...
							if(financial_user_field.indexOf(key) == -1){
								delete form_sub[key];
							}
						}
