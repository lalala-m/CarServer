		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="商家姓名" prop="business_name">
												<el-input id="business_name" v-model="form_sub['business_name']" placeholder="请输入商家姓名"
							  v-if="(form_sub['business_user_id'] && $check_field('set','business_name')) || (!form_sub['business_user_id'] && $check_field('add','business_name'))">
				  					</el-input>
					<div v-else-if="$check_field('get','business_name')">
						{{form_sub['business_name']}}
				  					</div>
														</el-form-item>
			</el-col>
								<el-col v-if="$check_field('get','business_gender') || $check_field('add','business_gender') || $check_field('set','business_gender')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="商家性别" prop="business_gender">
								<el-select id="business_gender" v-model="form_sub['business_gender']"
						v-if="(form_sub['business_user_id'] && $check_field('set','business_gender')) || (!form_sub['business_user_id'] && $check_field('add','business_gender'))">
						<el-option v-for="o in list_business_gender" :key="o" :label="o" :value="o">
						</el-option>
					</el-select>
					<div v-else-if="$check_field('get','business_gender')">{{form_sub['business_gender']}}</div>
										</el-form-item>
			</el-col>
				...
				<el-form-item label="手机号码" prop="mobile_phone_number">
						...
						v-if="(form_sub['business_user_id'] && $check_field('set','mobile_phone_number')) || (!form_sub['business_user_id'] && $check_field('add','mobile_phone_number'))">
					</el-input>
				...
				<el-form-item label="门店位置" prop="store_location">
												<el-input id="store_location" v-model="form_sub['store_location']" placeholder="请输入门店位置"
							  v-if="(form_sub['business_user_id'] && $check_field('set','store_location')) || (!form_sub['business_user_id'] && $check_field('add','store_location'))">
				  					</el-input>
					<div v-else-if="$check_field('get','store_location')">
						{{form_sub['store_location']}}
				  					</div>
														</el-form-item>
			</el-col>
...
<script>
	import mixin from "@/mixins/page.js";
		...
		created() {
								if(!this.query.business_user_id){
			this.form_sub["business_gender"] = this.list_business_gender[0];
		}
												},
	}
</script>
