<template>
	...
	<div class="statistics-info" v-if="statisticsData.total > 0">
				...
				<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable" row-key="financial_user_id" :tree-props="{ children: 'children', hasChildren: 'hasChildren' }"
			...
			<el-table-column prop="username" label="用户名" width="120">
				...
				<el-table-column fixed prop="nickname" label="昵称">
					...
					<el-table-column prop="financial_gender" @sort-change="$sortChange" label="员工性别" 				v-if="$check_field('get','financial_gender')" min-width="300">
					<template slot-scope="scope">
							{{ scope.row["financial_gender"] }}
									</template>
					</el-table-column>
