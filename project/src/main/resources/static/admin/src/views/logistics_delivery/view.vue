  ...
  <el-main class="bg edit_wrap comtable_e">
    <el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
      <el-row class="row_ce">
        ...
        <el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
          <el-form-item label="配送状态" prop="delivery_status">
            <el-input id="delivery_status" v-model="form['delivery_status']" placeholder="请输入配送状态" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
          <el-form-item label="配送员" prop="courier_name">
            <el-input id="courier_name" v-model="form['courier_name']" placeholder="请输入配送员" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
          <el-form-item label="配送详情" prop="courier_detail">
            <el-input id="courier_detail" v-model="form['courier_detail']" placeholder="请输入配送详情" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
          <el-form-item label="签收状态" prop="signing_status">
            <el-input id="signing_status" v-model="form['signing_status']" placeholder="请输入签收状态" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
      ...
      <el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
        <el-form-item v-if="$check_action('/logistics_delivery/view','set')">
