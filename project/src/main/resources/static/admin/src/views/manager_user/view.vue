		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="员工工号" prop="employee_work_number">
							  ...
							  v-if="(form_sub['manager_user_id'] && $check_field('set','employee_work_number')) || (!form_sub['manager_user_id'] && $check_field('add','employee_work_number'))">
				  					</el-input>
				...
				<el-form-item label="员工姓名" prop="employee_name">
							  ...
							  v-if="(form_sub['manager_user_id'] && $check_field('set','employee_name')) || (!form_sub['manager_user_id'] && $check_field('add','employee_name'))">
				  					</el-input>
				...
				<el-form-item label="员工性别" prop="employee_gender">
						...
						v-if="(form_sub['manager_user_id'] && $check_field('set','employee_gender')) || (!form_sub['manager_user_id'] && $check_field('add','employee_gender'))">
				...
				<el-form-item label="联系号码" prop="contact_number">
						...
						v-if="(form_sub['manager_user_id'] && $check_field('set','contact_number')) || (!form_sub['manager_user_id'] && $check_field('add','contact_number'))">
					</el-input>
				...
				<el-form-item label="二维码" prop="two_dimensional_code">
						...
						:show-file-list="false" v-if="(form_sub['manager_user_id'] && $check_field('set','two_dimensional_code')) || (!form_sub['manager_user_id'] && $check_field('add','two_dimensional_code'))">
				...
				<el-form-item v-if="$check_action('/manager_user/view','set') || $check_action('/manager_user/view','add')">
